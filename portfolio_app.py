...
PERSONAL_INFO = {
    ...
    "headline": "Aspiring Data Scientist | Data Science & AI Student at HTU | Aspiring AI Engineer | Co-Founder of Madmoon (FinTech) | Machine Learning & NLP | Cloud AI Engineer Intern @ LiverX | Google Cloud Digital Leader",
